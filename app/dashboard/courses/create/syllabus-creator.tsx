...
export function SyllabusCreator({ courseDetails, onComplete, isCreating }: SyllabusCreatorProps) {
  ...
  const generateSyllabus = async() => {
    ...
    if(response.ok){
      ...
      setSyllabusData(complete_syllabus)
      // console.log(complete_syllabus) 
      ...
      setIsGenerating(false)
     setActiveTab("edit")
      alert('error fetching AI Syllabus, showing mock data')
    ...
    setIsGenerating(false)
    setActiveTab("edit")
    alert('Error while generating AI Data . Try Again .Showing Mock data')
    setSyllabusData(mockSyllabus)
